  ...
  return (
    <div className="h-[200px] pt-8">
      <div className="bg-black px-9">
        <div className="font-bold text-gray-300 text-2xl  sm:text-3xl md: text:3xl lg:text-3xl font-fontt2 justify-center  mb-4 tracking-wider ">
          TOOLS ⚒️ :
