    ...
    <div className='w-full pt-7 px-4 bg-black'>
      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
        ...
        <div className='w-full shadow-xl bg-gray-300 text-black flex flex-col p-4 my-4 rounded-md hover:scale-105 duration-300 lg:h-[30rem]'>
          <a href='https://github.com/daysuwaa/Vans-Website-Clone' target='_blank' rel='noopener noreferrer' className='text-2xl font-bold flex justify-between items-center mt-6 font-fontt2 tracking-wider'>
            <span>Vans Clone</span>
            <span className='flex items-center'>
              <a href='https://daysuwaa.github.io/Vans-Website-Clone/' target='_blank' rel='noopener noreferrer'>
        ...
        {/* Uber */}
        <div className='w-full shadow-xl bg-gray-300 text-black flex flex-col p-4 my-4 rounded-md hover:scale-105 duration-300 lg:h-[30rem]'>
          <a href=' https://github.com/daysuwaa/Uber-clone' target='_blank' rel='noopener noreferrer' className='text-2xl font-bold flex justify-between items-center mt-6 font-fontt2 tracking-wider'>
            <span>Uber Clone</span>
            <span className='flex items-center'>
              <a href='https://daysuwaa.github.io/Uber-clone/' target='_blank' rel='noopener noreferrer'>
                <FiLink className='mr-2' />
              </a>
              <FaGithub className='ml-2' />
            </span>
        ...
        {/* Flickr */}
        <div className='w-full shadow-xl bg-gray-300 text-black flex flex-col p-4 my-4 rounded-md hover:scale-105 duration-300 lg:h-[30rem]'>
          <a href='https://github.com/daysuwaa/Flickr-clone' target='_blank' rel='noopener noreferrer' className='text-2xl font-bold flex justify-between items-center mt-6 font-fontt2 tracking-wider'>
            <span>Flickr</span>
            <span className='flex items-center'>
              <a href='https://daysuwaa.github.io/Flickr-clone/ ' target='_blank' rel='noopener noreferrer'>
                <FiLink className='mr-2' />
              </a>
              <FaGithub className='ml-2' />
            </span>
        ...
        {/* LockLingo */}
        <div className='w-full shadow-xl bg-gray-300 text-black flex flex-col p-4 my-4 rounded-md hover:scale-105 duration-300 lg:h-[30rem]'>
          <a href='https://github.com/daysuwaa/Random-Password-Generator' target='_blank' rel='noopener noreferrer' className='text-2xl font-bold flex justify-between items-center mt-6 font-fontt2 tracking-wider'>
            <span>LockLingo</span>
            <span className='flex items-center'>
              <a href='https://daysuwaa.github.io/Random-Password-Generator/' target='_blank' rel='noopener noreferrer'>
                <FiLink className='mr-2' />
              </a>
              <FaGithub className='ml-2' />
            </span>
        ...
        {/* DeployMate */}
        <div className='w-full shadow-xl bg-gray-300 text-black flex flex-col p-4 my-4 rounded-md hover:scale-105 duration-300 lg:h-[30rem]'>
          <a href='https://github.com/daysuwaa/Document' target='_blank' rel='noopener noreferrer' className='text-2xl font-bold flex justify-between items-center mt-6 font-fontt2 tracking-wider'>
